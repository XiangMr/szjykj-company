package com.dome.szjykjcompany.shiro.config;

import at.pollux.thymeleaf.shiro.dialect.ShiroDialect;
import com.dome.szjykjcompany.shiro.realm.UserRealm;
...
public class ShiroConfiguration {
    ...
    @Autowired
    private com.dome.szjykjcompany.utils.applicationUtils applicationUtils;
    ...
    public HashedCredentialsMatcher hashedCredentialsMatcher() {
        ...
        credentialsMatcher.setHashAlgorithmName(applicationUtils.gethashAlgorithmName);;
        //credentialsMatcher.setStoredCredentialsHexEncoded(true); // 这一行决定hex还是base64
        //credentialsMatcher.setHashAlgorithmName(hashAlgorithmName);//设置凭证方式
        credentialsMatcher.setHashIterations(applicationUtils.gethashIterations);//设置散列次数
    ...
    public ShiroFilterFactoryBean getShiroFilterFactoryBean(DefaultWebSecurityManager securityManager){
        ...
        filterChainDefinitionsMap.put("/echartsJS/**","anon");
        filterChainDefinitionsMap.put("/icheck/**","anon");
        filterChainDefinitionsMap.put("/image/**","anon");
        filterChainDefinitionsMap.put("/javascript/**","anon");
        filterChainDefinitionsMap.put("/js/**","anon");
        filterChainDefinitionsMap.put("/layer/**","anon");
        filterChainDefinitionsMap.put("/layui/**","anon");

        /*---------------------->请求放行<----------------------<*/
        filterChainDefinitionsMap.put("/login/**","anon");//登录页面
        filterChainDefinitionsMap.put("/login.html/**","anon");//登录页面
        filterChainDefinitionsMap.put("/druid/**","anon");//aili连接池
        filterChainDefinitionsMap.put("/Userlogin","anon");//登录请求
        filterChainDefinitionsMap.put("/favicon.ico","anon");//去到登录页面
        filterChainDefinitionsMap.put("/unauthorize","anon");//去到权限不足页面
        //退出
